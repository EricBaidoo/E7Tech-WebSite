...
<section class="pt-40 pb-0 bg-white relative overflow-hidden z-0">
    ...
    <div class="max-w-6xl mx-auto px-4 text-center relative z-10 flex flex-col items-center">
        ...
        <!-- Trust Badge -->
        <div class="hero-reveal inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-50 text-slate-500 text-[10px] font-bold tracking-[0.2em] uppercase mb-8 border border-slate-200 shadow-sm">
            <span class="w-1.5 h-1.5 rounded-full bg-brand-blue animate-pulse"></span>
            Africa's Trusted Technology Partner
        </div>

        <!-- Headline -->
        <h1 class="hero-reveal hero-delay-1 text-[3.5rem] md:text-[5.5rem] lg:text-[6.5rem] font-black text-slate-900 tracking-tighter mb-6 leading-[1.02] max-w-5xl">
            Smarter. Safer.<br>
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-cyan-500">More Efficient.</span>
        </h1>

        <!-- Subtext -->
        <p class="hero-reveal hero-delay-2 text-xl md:text-2xl text-slate-500 mb-12 max-w-2xl font-light leading-relaxed tracking-tight">
        ...
        <div class="hero-reveal hero-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4 mb-14 w-full sm:w-auto">
            <a href="solutions" class="w-full sm:w-auto px-8 py-4 rounded-xl bg-slate-900 text-white font-semibold tracking-tight hover:bg-slate-800 transition-all shadow-[0_10px_40px_rgba(0,0,0,0.18)] hover:shadow-[0_15px_50px_rgba(0,0,0,0.28)] hover:-translate-y-0.5">
                Explore Our Solutions
            </a>
            <a href="contact" class="w-full sm:w-auto px-8 py-4 rounded-xl bg-white text-slate-700 font-semibold tracking-tight hover:bg-slate-50 transition-all border border-slate-200 shadow-sm hover:shadow-md">
                <i class="fas fa-calendar-alt text-brand-blue mr-2"></i>Book a Free Strategy Call
            </a>
        </div>

        <!-- Stats Bar -->
        <div class="hero-reveal hero-delay-4 flex flex-wrap justify-center items-center gap-0 divide-x divide-slate-200 border border-slate-200 rounded-2xl bg-slate-50/80 backdrop-blur px-2 py-1 mb-20 shadow-sm">
        ...
        <!-- Hero Image — bleeds into next section -->
        <div class="relative w-full max-w-5xl mx-auto">
            <div class="absolute inset-0 bg-brand-blue/15 blur-[80px] rounded-full scale-90 -z-10 transform translate-y-8 pointer-events-none"></div>
            <div class="relative z-20 overflow-hidden rounded-t-3xl border-t border-l border-r border-slate-200/70 shadow-[0_-20px_80px_-20px_rgba(0,0,0,0.12)] bg-white/50 backdrop-blur-3xl p-2 md:p-3 pb-0">
                <img src="assets/images/sliders/slide1.png" alt="E7 Technology Platform Dashboard" class="w-full h-auto rounded-t-2xl border border-slate-200/50">
                <div class="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-white via-white/70 to-transparent z-30"></div>
            </div>
        </div>
    </div>
</section>
...
<section class="py-24 bg-[#FAFAFA] border-t border-slate-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            <div class="inline-block px-3 py-1 rounded-full bg-slate-200 text-slate-600 text-[10px] font-bold uppercase tracking-[0.2em] mb-6">Our Ecosystem</div>
            <h2 class="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter mb-5 leading-[1.1]">One partner.<br>Every technology need.</h2>
            <p class="text-lg text-slate-500 font-light leading-relaxed">Whether you need to secure your systems, make smarter decisions with data, or build world-class software — E7 has a solution purpose-built for you.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            
            <!-- E7Shield -->
            <a href="solutions/e7shield" class="group bg-white border border-slate-200 rounded-3xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
            ...
            <!-- E7Insight (Featured) -->
            <a href="solutions/e7insight" class="group bg-slate-950 border border-slate-800 rounded-3xl p-8 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col relative overflow-hidden">
            ...
            <!-- E7Build -->
            <a href="solutions/e7build" class="group bg-white border border-slate-200 rounded-3xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
                <div class="w-14 h-14 rounded-2xl bg-slate-100 flex items-center justify-center mb-6 group-hover:bg-slate-900 transition-all duration-300">
...
<section class="py-32 bg-slate-950 text-white text-center relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 relative z-10 flex flex-col items-center">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-[10px] font-bold uppercase tracking-[0.2em] mb-10">
            <i class="fas fa-calendar-alt text-brand-blue"></i> Free Consultation — No Obligation
        </div>
        <h2 class="text-5xl md:text-7xl font-black mb-8 tracking-tighter leading-tight">Ready to transform<br>your organization?</h2>
        <p class="text-xl text-slate-400 mb-12 font-light max-w-2xl tracking-tight leading-relaxed">Join 50+ organizations across Africa that trust E7 to protect, empower, and grow their operations with trusted technology.</p>
        <div class="flex flex-col sm:flex-row gap-4 items-center">
            <a href="contact" class="inline-flex items-center gap-3 px-10 py-5 rounded-2xl bg-white text-slate-950 text-xl font-bold hover:bg-slate-100 transition-all tracking-tight shadow-[0_0_40px_rgba(255,255,255,0.08)] hover:shadow-[0_0_60px_rgba(255,255,255,0.15)]">
