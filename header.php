...
<body>
            ...
            <div class="header-wrapper">
                ...
                <nav class="main-nav">
                    ...
                    <div class="nav-item has-dropdown">
                        <a href="<?php echo $navBasePath; ?>about.php" class="nav-link">
                            About Us
                            <i class="fas fa-chevron-down dropdown-icon"></i>
                        </a>
                        <div class="dropdown-menu">
                            <a href="<?php echo $navBasePath; ?>about.php" class="dropdown-item">
                            ...
                            <a href="<?php echo $navBasePath; ?>about.php#leadership" class="dropdown-item">
                            ...
                            <a href="<?php echo $navBasePath; ?>about.php#gallery" class="dropdown-item">
                    ...
                    <div class="nav-item has-dropdown">
                        <a href="<?php echo $navBasePath; ?>services.php" class="nav-link">
                            Services
                            <i class="fas fa-chevron-down dropdown-icon"></i>
                        </a>
                        <div class="dropdown-menu mega-menu">
                            <div class="mega-menu-grid">
                                <a href="<?php echo $navBasePath; ?>services.php#cybersecurity" class="dropdown-item">
                                ...
                                <a href="<?php echo $navBasePath; ?>services.php#cloud" class="dropdown-item">
                                ...
                                <a href="<?php echo $navBasePath; ?>services.php#analytics" class="dropdown-item">
                                ...
                                <a href="<?php echo $navBasePath; ?>services.php#ai" class="dropdown-item">
                    ...
                    <a href="<?php echo $navBasePath; ?>solutions.php" class="nav-link">Solutions</a>
                    <a href="<?php echo $navBasePath; ?>academy.php" class="nav-link">E7 Academy</a>
                    <a href="<?php echo $navBasePath; ?>news.php" class="nav-link">News</a>
                    <a href="<?php echo $navBasePath; ?>contact.php" class="btn-contact">
    ...
    <div class="mobile-nav" id="mobileNav">
        ...
        <div class="mobile-nav-content">
            <a href="<?php echo $navBasePath; ?>index.php" class="mobile-nav-link">
            ...
            <div class="mobile-nav-item">
                ...
                <div class="mobile-dropdown-content">
                    <a href="<?php echo $navBasePath; ?>about.php" class="mobile-dropdown-link">About E7</a>
                    <a href="<?php echo $navBasePath; ?>about.php#leadership" class="mobile-dropdown-link">Leadership Team</a>
                    <a href="<?php echo $navBasePath; ?>about.php#gallery" class="mobile-dropdown-link">Gallery</a>
                </div>
            </div>
            ...
            <div class="mobile-nav-item">
                ...
                <div class="mobile-dropdown-content">
                    <a href="<?php echo $navBasePath; ?>services.php#cybersecurity" class="mobile-dropdown-link">Cybersecurity</a>
                    <a href="<?php echo $navBasePath; ?>services.php#cloud" class="mobile-dropdown-link">Cloud Solutions</a>
                    <a href="<?php echo $navBasePath; ?>services.php#analytics" class="mobile-dropdown-link">Data Analytics</a>
                    <a href="<?php echo $navBasePath; ?>services.php#ai" class="mobile-dropdown-link">AI & Machine Learning</a>
                </div>
            </div>
            
            <a href="<?php echo $navBasePath; ?>solutions.php" class="mobile-nav-link">
                <i class="fas fa-lightbulb"></i>
                <span>Solutions</span>
            </a>
            
            <a href="<?php echo $navBasePath; ?>academy.php" class="mobile-nav-link">
                <i class="fas fa-graduation-cap"></i>
                <span>E7 Academy</span>
            </a>
            
            <a href="<?php echo $navBasePath; ?>news.php" class="mobile-nav-link">
                <i class="fas fa-newspaper"></i>
                <span>News</span>
            </a>
            
            <a href="<?php echo $navBasePath; ?>contact.php" class="mobile-nav-link mobile-nav-cta">
